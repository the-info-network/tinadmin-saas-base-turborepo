...
const createIcon = (IconComponent: React.ComponentType) => React.createElement(IconComponent);
...
export const mainNavItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Integrations", path: "/saas/admin/system-admin/integrations", new: true },
